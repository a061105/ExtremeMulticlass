...
class SplitOracleActBCD{
	...
	Model* solve(){
		...
		//main loop
		float_type starttime = omp_get_wtime();
		float_type search_time=0.0, subsolve_time=0.0, maintain_time=0.0;
		float_type last_search_time = 0.0, last_subsolve_time = 0.0, last_maintain_time = 0.0;
		...
		float_type endtime = omp_get_wtime();
		cerr << endl;
